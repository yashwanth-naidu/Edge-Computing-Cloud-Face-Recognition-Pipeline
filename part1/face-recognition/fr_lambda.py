        ...
        for record in records_list:
            ...
            try:
                ...
                for known_emb in known_embeddings:
                    dist_value = torch.dist(face_embedding, known_emb).item()
                    distance_scores.append(dist_value)
                
                # Find best match
                best_match_idx = distance_scores.index(min(distance_scores))
                best_distance = distance_scores[best_match_idx]
